...
module.exports = function(RED) {
    ...
    RED.httpAdmin.get("/metricSensors/:id", async function (request, response) {
        var id = request.params.id;
        ...
        await telldus.getSensors().then(sensors => {
            var elements = [];
    ...
    RED.httpAdmin.get("/switchSensors/:id", async function (request, response) {
        var id = request.params.id;
